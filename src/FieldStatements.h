...
private:
	...
	static void DefaultValueAdd( const CDaoFieldInfo &fieldinfo,CDaoTableDefInfo &tabledefinfo,CString &sStatement, CDaoFieldInfo &recordinfo, unsigned &nWarningCount, std::vector<CString> &constraints, std::vector<wxString> &warnings);
