This is the README file for the mdb2sqliteionalization sample for wxWidgets.
...
A. First of all, you will need the GNU gettext tools (see the next questions).
   ...
   xgettext -C -n -k_ -kwxPLURAL:1,2 -kwxTRANSLATE -o mdb2sqlite.po ../mdb2sqlite.cpp
   ...
   vi mdb2sqlite.po wxstd.pot

   # create the message catalog files
   msgfmt -o mdb2sqlite.mo mdb2sqlite.po
...
Q. How to do update the translation of 'mdb2sqlite' sample for a language?
A. First of all, you will need the GNU gettext tools (see the next question).
   ...
   xgettext -j -C -n -k_ -kwxPLURAL:1,2 -kwxTRANSLATE -o mdb2sqlite.po ../mdb2sqlite.cpp
...
Q. What's i18n?
A. Count the number of letters in the word "mdb2sqliteionalization".
